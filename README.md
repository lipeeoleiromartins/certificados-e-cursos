# 🎓 Cursos e Certificações - Felipe Oleiro Martins

Repositório dedicado ao armazenamento, organização e validação de certificados obtidos durante a graduação em **Análise e Desenvolvimento de Sistemas**, focado em **Linguagem Python, Ciência de Dados e Cibersegurança**.
...
| Categoria | Curso / Formação | Instituição / Plataforma | Carga Horária | Data | Comprovante |
| :--- | :--- | :--- | :---: | :---: | :---: |
